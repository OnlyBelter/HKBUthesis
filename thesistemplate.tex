...
\AtEveryBibitem{\clearfield{language}\clearlist{language}} 

\captionsetup[figure]{font={stretch=1.0}}
\raggedbottom
% https://stackoverflow.com/a/643688/2803344
% \captionsetup{singlelinecheck=false,labelsep=period,font=footnotesize,labelfont={bf}}
